...
const STRINGS = {
  en: {
    ...
    farewellEyebrow: "Your Catch the King 2026 wrapped",
    farewellPlayedSets: "Your played sets",
    farewellHeroGameName: "CATCH THE KING",
    farewellTitle: "Thanks for playing!",
    farewellIntro:
      "Hope this helper made the <strong>Catch the King</strong> event a bit easier for you.",
    setsFarmed: "Sets farmed (games × 5)",
    farewellFooter: "Tracked locally on this device only.",
    farewellDonate:
      "This site will always stay ad-free &mdash; I'm just genuinely happy you used it. " +
      "If you'd like to throw a coin in the hat, a tip on " +
      "<a href='https://paypal.me/jogoe' target='_blank' rel='noopener'>PayPal</a> means a lot.",
    farewellDownload: "⬇  Download PNG",
    farewellCopy: "📋  Copy image",
    farewellShare: "Share",
    farewellCopied: "Image copied to clipboard!",
    farewellCopyFailed: "Copy failed — try the download button.",
    farewellOpenBtn: "View event summary",
    farewellOpenTitle: "Open event summary again",
    farewellShareTitle: "Brag a little!",
    farewellShareBody: "Save your wrapped & share it with the Discord — let your friends see what you pulled off.",
    farewellDonateTitle: "Did the helper help you?",
    farewellDonateBtn: "💛  Tip on PayPal",
    farewellOutro: "Looking forward to next year — it was a pleasure. <3",
    ...
    // ----- footer -----
    footerText: "Clean-room helper for Metin2 · Catch the King",
    // ----- ui.js dynamic -----
  ...
  de: {
    ...
    farewellEyebrow: "Dein Schnapp den König 2026 wrapped",
    farewellPlayedSets: "Deine gespielten Sets",
    farewellHeroGameName: "SCHNAPP DEN KÖNIG",
    farewellTitle: "Danke fürs Mitspielen!",
    farewellIntro:
      "Hoffe der Helfer hat dir das <strong>Schnapp den K&ouml;nig</strong>-Event ein bisschen leichter gemacht.",
    setsFarmed: "Sets gefarmt (Spiele × 5)",
    farewellFooter: "Wird nur lokal auf diesem Gerät gespeichert.",
    farewellDonate:
      "Wenn dir der Helfer Zeit erspart hat, hält ein kleiner Tipp die Seite werbefrei und motiviert für nächstes Jahr.",
    farewellDownload: "⬇  PNG herunterladen",
    farewellCopy: "📋  Bild kopieren",
    farewellShare: "Teilen",
    farewellCopied: "Bild in die Zwischenablage kopiert!",
    farewellCopyFailed: "Kopieren fehlgeschlagen — nutze den Download-Button.",
    farewellOpenBtn: "Event-Zusammenfassung",
    farewellOpenTitle: "Event-Zusammenfassung erneut anzeigen",
    farewellShareTitle: "Zeig was du gerissen hast!",
    farewellShareBody: "Speicher dein Wrapped und teil es im Discord — lass deine Freunde sehen, was du diesem Event abgerungen hast.",
    farewellDonateTitle: "Hat dir das Helfer-Tool geholfen?",
    farewellDonateBtn: "💛  Auf PayPal spenden",
    farewellOutro: "Freue mich auf nächstes Jahr — war mir eine Freude. <3",
  ...
  tr: {
    ...
    farewellEyebrow: "Catch the King 2026 özetin",
    farewellPlayedSets: "Oynadığın setler",
    farewellHeroGameName: "CATCH THE KING",
    farewellTitle: "Oynadığın için teşekkürler!",
    farewellIntro:
      "Umarım bu yardımcı <strong>Schnapp den K&ouml;nig</strong> etkinliğini biraz kolaylaştırmıştır.",
    setsFarmed: "Toplanan set (oyun × 5)",
    farewellFooter: "Yalnızca bu cihazda yerel olarak takip edilir.",
    farewellDonate:
      "Yardımcı bu etkinlikte zamanını kurtardıysa, küçük bir destek siteyi reklamsız tutar ve sonraki özellikler için motive eder.",
    farewellDownload: "⬇  PNG indir",
    farewellCopy: "📋  Görseli kopyala",
    farewellShare: "Paylaş",
    farewellCopied: "Görsel panoya kopyalandı!",
    farewellCopyFailed: "Kopyalama başarısız — indirme düğmesini dene.",
    farewellOpenTitle: "Etkinlik özetini tekrar göster",
    farewellShareTitle: "Biraz övün!",
    farewellShareBody: "Özetini kaydet ve Discord'da paylaş — arkadaşlarına neler yaptığını göster.",
    farewellDonateTitle: "Bir kahve ısmarlar mısın?",
    farewellDonateBtn: "💛  PayPal'da bağış yap",
    farewellOutro: "Gelecek yıl görüşmek üzere — keyifliydi. <3",
  ...
  ro: {
    ...
    farewellEyebrow: "Catch the King 2026 wrapped",
    farewellPlayedSets: "Seturile tale jucate",
    farewellHeroGameName: "PRINDE REGELE",
    farewellTitle: "Mulțumim că ai jucat!",
    farewellIntro:
      "Sperăm că acest ajutor ți-a făcut evenimentul <strong>Prinde Regele</strong> puțin mai ușor.",
    setsFarmed: "Seturi farmate (jocuri × 5)",
    farewellFooter: "Urmărit doar local pe acest dispozitiv.",
    farewellDonate:
      "Dacă ajutorul ți-a economisit timp în acest eveniment, un mic bacșiș păstrează site-ul fără reclame și motivează următoarele funcții.",
    farewellDownload: "⬇  Descarcă PNG",
    farewellCopy: "📋  Copiază imaginea",
    farewellShare: "Distribuie",
    farewellCopied: "Imagine copiată în clipboard!",
    farewellCopyFailed: "Copierea a eșuat — folosește butonul de descărcare.",
    farewellOpenTitle: "Arată din nou rezumatul evenimentului",
    farewellShareTitle: "Lăudă-te puțin!",
    farewellShareBody: "Salvează-ți rezumatul și împărtășește-l pe Discord — lasă-ți prietenii să vadă ce ai reușit.",
    farewellDonateTitle: "Îmi cumperi o cafea?",
    farewellDonateBtn: "💛  Donează pe PayPal",
    farewellOutro: "Aștept anul viitor — a fost o plăcere. <3",
  ...
  es: {
    ...
    farewellEyebrow: "Tu Catch the King 2026 wrapped",
    farewellPlayedSets: "Tus sets jugados",
    farewellHeroGameName: "ATRAPA AL REY",
    farewellTitle: "¡Gracias por jugar!",
    farewellIntro:
      "Espero que este ayudante te haya hecho el evento <strong>Atrapa al Rey</strong> un poco más fácil.",
    setsFarmed: "Sets farmeados (partidas × 5)",
    farewellFooter: "Registrado solo localmente en este dispositivo.",
    farewellDonate:
      "Si el ayudante te ahorró tiempo este evento, una pequeña propina mantiene la página sin anuncios y motiva las próximas mejoras.",
    farewellDownload: "⬇  Descargar PNG",
    farewellCopy: "📋  Copiar imagen",
    farewellShare: "Compartir",
    farewellCopied: "¡Imagen copiada al portapapeles!",
    farewellCopyFailed: "Copia fallida — usa el botón de descarga.",
    farewellOpenTitle: "Mostrar resumen del evento de nuevo",
    farewellShareTitle: "¡Presume un poco!",
    farewellShareBody: "Guarda tu wrapped y compártelo en Discord — que tus amigos vean lo que conseguiste.",
    farewellDonateTitle: "¿Me invitas a un café?",
    farewellDonateBtn: "💛  Donar en PayPal",
    farewellOutro: "Hasta el año que viene — fue un placer. <3",
  ...
  pl: {
    ...
    farewellEyebrow: "Twój Catch the King 2026 wrapped",
    farewellPlayedSets: "Twoje rozegrane sety",
    farewellHeroGameName: "ZŁAP KRÓLA",
    farewellTitle: "Dzięki za granie!",
    farewellIntro:
      "Mam nadzieję, że ten helper trochę ułatwił ci wydarzenie <strong>Złap Króla</strong>.",
    setsFarmed: "Zafarmione sety (gry × 5)",
    farewellFooter: "Śledzone tylko lokalnie na tym urządzeniu.",
    farewellDonate:
      "Jeśli helper zaoszczędził ci czasu w tym wydarzeniu, mały napiwek utrzyma stronę bez reklam i zmotywuje do kolejnych funkcji.",
    farewellDownload: "⬇  Pobierz PNG",
    farewellCopy: "📋  Kopiuj obraz",
    farewellShare: "Udostępnij",
    farewellCopied: "Obraz skopiowany do schowka!",
    farewellCopyFailed: "Kopiowanie nieudane — użyj przycisku pobierania.",
    farewellOpenTitle: "Pokaż podsumowanie wydarzenia ponownie",
    farewellShareTitle: "Pochwal się!",
    farewellShareBody: "Zapisz swój wrapped i wrzuć go na Discord — niech znajomi zobaczą, co osiągnąłeś.",
    farewellDonateTitle: "Postawisz mi kawę?",
    farewellDonateBtn: "💛  Wpłać na PayPal",
    farewellOutro: "Do zobaczenia za rok — była to przyjemność. <3",
